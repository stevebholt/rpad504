...
👨‍🏫: Stephen Holt, Ph.D.\
📅: Thursdays from 6:00 pm to 8:50 pm in Husted 004\
📧: sbholt\@albany.edu\
🏫: Mondays from 1:00 pm to 5:00 pm or by appointment - book [here](https://calendly.com/sbholt/30min); in-person in Milne 324 or online in [Zoom](https://albany.zoom.us/my/sbholt). ☎️: 518-442-3309
...
R and RStudio - As an alternative to Stata, you can use the free statistical software [R](https://cran.r-project.org/bin/windows/base/) and [RStudio](https://posit.co/download/rstudio-desktop/). I will provide a path to learn the course in R as well.

::: {callout-important}
There are three important things to consider when using R for this course. First, RPAD 505 will be taught in Stata, so learning Stata here can really help you develop your skills further in a consistent software. Second, R has a steeper learning curve and generally worse documentation than Stata - as it is opensource and community governed - and you should think about using R in this course as taking this course in "hard" mode. If you are not particularly good with computers or technology at this point in time, I strongly recommend using Stata. Third, I am less proficient in R than Stata and will therefore be less able to assist should you run into trouble.
:::
...
1.  Weekly Problem Sets or Memos (30 points)
2.  Mid-term Exam (25 points)
...
### Weekly Problem Sets {#sec-problemsets}

For 10 weeks throughout the semester (see @sec-overview.weeks for the specific weeks), problem sets will be disseminated at the start of class and will have a 30 minute time limit for completion. Problem sets will involve applying concepts and activities we completed in class together the prior week to new but similar datasets and problems on your own. You will be expected to turn in 1) a clean answer sheet that provides the final solution to any problem; and 2) a .log file that shows the code used to derive the solutions to the problems.
...
Each problem set is worth 3 points and your lowest two scores will be dropped. Missed classes with a problem set will result in a 0 on that problem set.

### Mid-term and Final Exams {#sec.exams}
...
Attendance and participation in class discussion and activities will determine the participation points you earn at the end of the semester. Consistent with the problem set policy, two absences will be forgiven. Each additional absence will lead to a deduction of 5 points from the grade participation score.
...
| 9/4 | Data Origins | 👨‍🏫 | 📄 Knox et al. <br> 📄 Llolbrera & Hall <br> 📄 Holt & Vinopal |
| 9/11 | Assessing Data Quality | 👨‍🏫 | 📄 National Academies of SEM: <br> Appendices A and C |
| 9/18 | Summarizing Data I | 👨‍🏫 <br> ✅ <br> 👥 | 📄 Huntington-Klein |
| 9/25 | Summarizing Data II | 👨‍🏫 <br> ✅ <br> 👥 |  |
| 10/2 | Data Management | 👨‍🏫 <br> ✅ <br> 👥 | 📄 Kroenke & Auer (Ch. 1 & 2) <br> 📄 Kohler & Kreuter |
| 10/9 | Geographic Information and Mapping Data | 👨‍🏫 <br> ✅ <br> 👥 |  |
| 10/16 | Midterm Exam | 📅 |  |
| 10/23 | Writing About Data | 👨‍🏫 <br> ✅ <br> 👥 |  |
| 10/30 | Light Statistics Introduction | 👨‍🏫 <br> ✅ <br> 👥 |  |
| 10/30 | Statistical Models I | 👨‍🏫 <br> ✅ <br> 👥 |  |
| 11/6 | Statistical Models II | 👨‍🏫 <br> ✅ <br> 👥 |  |
| 11/13 | Forecasting and Projection | 👨‍🏫 <br> ✅ <br> 👥 |  |
| 11/20 | Decision Trees | 👨‍🏫 <br> ✅ <br>📅 |  |
...
-   After the first week, readings for each week should be completed by the Wednesday of that week (that is, BEFORE CLASS!). While much of the class reading comes from assigned readings, I will cover other material in my lectures. **You will be responsible for knowing this material too!**
-   A large body of well-designed research has demonstrated the detrimental effects of laptops on learning in a lecture/discussion based environment. Outside of specific accommodations, laptops are forbidden for use unless called for by the instructor for specific in-class assignments and activities. Cellular phones are not to be used during class time!
...
-   Attend/participate in class! Again, class participation is 15% of your grade, and you can't participate if you're not in class or watching the class videos. If you DO need to miss class (emergencies, sickness, etc.), please contact me as soon as possible and let me know. It will be your responsibility to notify me and to get any notes/materials from other students.
